...
#ifndef BIFURCATIONASYMMETRIC_HPP
#define BIFURCATIONASYMMETRIC_HPP
...
class BifurcationAsymmetric : public BuildingBlock
{
public:
    BifurcationAsymmetric(commPtr_Type comm, std::string refinement = "coarse",
                         bool verbose = false);
...
#endif  // BIFURCATIONASYMMETRIC_HPP
