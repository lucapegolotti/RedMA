...
#ifndef aMATRICESGENERATOR_HPP
#define aMATRICESGENERATOR_HPP
...
/*! \brief Abstract class for generating the finite element matrices necessary to the
* offline phase of the reduced basis method.
*/
class aMatricesGenerator
{
...
public:
     ...
     */
    aMatricesGenerator(const DataContainer& data,
                       EPETRACOMM comm);
...
protected:
    ...
    virtual void createAssemblers() = 0;
